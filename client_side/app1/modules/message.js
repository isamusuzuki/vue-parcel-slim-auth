export default {
    ...
    actions: {
        error (context, payload) {
            context.commit('errorUpdate', {isShow: true, messages: payload.messages});
        ...
        success (context, payload) {
            context.commit('successUpdate', {isShow: true, messages: payload.messages});
            window.scroll(0, 0); //文書の左上にスクロール位置をリセット
        },
        successClear (context, payload) {
